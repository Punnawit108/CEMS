/*
* ชื่อไฟล์: TC_E2E_listWithdraw_003_002_Failure.cy.js
* คำอธิบาย: E2e สร้างใบเบิกค่าใช้จ่าย บันทึก Failure
...
describe("ManageExpeneFormTest", () => {
    ...
    it('หลังจากเข้าสู่ระบบ', () => {
        ...
        cy.xpath('/html/body/div/div/div/div/div/div[2]/form/div[1]/button[1]').click()
        cy.wait(1000);
