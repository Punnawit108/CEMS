describe("ExpenseManage Tests", () => {
    ...
    it("แก้ไขประเภทค่าใช้จ่าย", () => {
      ...
      cy.get(':nth-child(10) > .justify-between > .justify-end > :nth-child(1)').click();
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[4]/div/div[1]/form/div/input').clear();
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[4]/div/div[1]/form/div/input').type("ค่าเน็ต2");
      cy.get('.btn-ยืนยัน').click();
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[5]/div/div[2]/button[2]').click();
      cy.contains("ยืนยันการแก้ไขข้อมูลประเภทค่าใช้จ่ายสำเร็จ");
    });
  });
