/*
 * ชื่อไฟล์: TS_E2E_DisbursementApprover_012_005_Success.cy.js
 * คำอธิบาย: E2e
...
describe("DisbursementApprover Test", () => {
  ...
  it("หลังจากเข้าสู่ระบบ", () => {
    ...
    cy.wait(3000);
      ...
      cy.xpath('//*[@id="SearchBar"]').type("ISatawat Thitilen");
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div/div[2]/div[2]').should("contain","ISatawat Thitilen");
  });
});
