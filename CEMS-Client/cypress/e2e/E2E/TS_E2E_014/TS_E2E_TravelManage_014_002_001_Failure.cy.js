describe("TravelManage Tests", () => {
    ...
    it("เพิ่มประเภทค่าเดินทาง", () => {
      ...
      cy.get('.btn-ประเภทรถสาธารณะ').click();
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[7]/div/div[1]/form/div/input').type("เครื่องบิน");
      cy.get(".btn-ยืนยัน").click();
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[8]/div/div[2]/button[2]').click();
      cy.contains("ยืนยันการเพิ่มข้อมูลประเภทค่าเดินทางสาธารณะไม่สำเร็จ");
    });
  });
