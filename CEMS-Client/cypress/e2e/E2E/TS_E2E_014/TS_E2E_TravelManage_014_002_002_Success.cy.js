describe("TravelManage Tests", () => {
    ...
    it("เพิ่มประเภทค่าเดินทาง", () => {
      ...
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[5]/div[2]/div[5]/div/div[2]/button[1]').click();
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[7]/div/div[1]/form/div/input').clear();
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[7]/div/div[1]/form/div/input').type("วินมอเตอร์ไซค์");
      cy.get(".btn-ยืนยัน").click();
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[8]/div/div[2]/button[2]').click();
      cy.contains("ยืนยันการแก้ไขข้อมูลประเภทค่าเดินทางสาธารณะสำเร็จ");
    });
  });
