...
* ชื่อไฟล์: TC_E2E_historyWithdraw_004_001_Success.cy.js
* คำอธิบาย: E2E ดูรายละเอียดคำขอเบิกค่าใช้จ่าย ที่มีสถานะ "อนุมัติ" ส่งออก(สำเร็จ)
...
describe("Dashboard Tests", () => {
  ...
  it('หลังจากเข้าสู่ระบบ', () => {
    ...
    // กดปุ่มไอคอน "จัดการ"
    cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div/div[2]/table/tbody/tr[1]/th[8]/span/div').click();
    // ตรวจสอบว่า URL เปลี่ยนไปตามที่คาดไว้
