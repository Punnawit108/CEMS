...
*/describe("ManageExpeneFormTest", () => {
    beforeEach(() => {
      ...
      it('หลังจากเข้าสู่ระบบ', () => {
          ...
          cy.xpath('//*[@id="app"]/div/div/div/nav/ul/li[5]/ul/li[2]/a/a/div[1]').click();
  
          // ตรวจสอบว่า URL เปลี่ยนไปตามที่คาดไว้
          cy.url().should('include', '/payment/history');
          // ตรวจสอบว่าหน้ามีข้อความ "รายการเบิกค่าใช้จ่าย"
          cy.wait(2000);
          cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div/div[2]/table/tbody/tr[1]/th[8]/span').click();
          cy.wait(1000);
