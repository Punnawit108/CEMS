describe("FT_ReportExpenseProject_005", () => {
  ...
  it("ตรวจสอบการทำงานของของระบบ เมื่อสร้างใบเบิกเป็นค่าเดินทาง รถสาธารณะ", () => {
    ...
    cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[1]/div[4]/div/div/div[1]/button[1]').should("be.visible").click();
    cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[1]/div[4]/div/div/div[3]/button[2]').should("be.visible").click();
