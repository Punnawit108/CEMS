describe("Dashboard Tests", () => {
    ...
    it("ตรวจสอบหน้า สร้างใบเบิกค่าใช้จ่าย", () => {
      ...
      cy.xpath('//*[@id="projectName"]').select('ประชุมกับลูกค้า');
      
      cy.xpath('//*[@id="expenseType"]').select('ค่าอาหาร');
      cy.xpath('//*[@id="rqExpenses"]').type("50");
      cy.xpath('//*[@id="rqInsteadEmail"]').select('Alisa Pakungpalung');
      cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/form/div[2]/div[2]/textarea').type("เบิกค่าอาหาร");
