describe("ทดสอบการลบประเภทค่าเดินทางรถส่วนตัว", () => {
    beforeEach("ล็อกอินเข้าสู่ระบบ", () => {
      cy.login("65160341", "admin");
    });
  
    it("ตรวจสอบการลบประเภทค่าค่าเดินทางรถส่วนตัว โดยกระบวนการตั้งแต่ต้นจนจบ", () => {
        ...
        cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[3]/div/div[4]/div/div[2]/button[2]').should('be.visible');
        cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[3]/div/div[4]/div/div[2]/button[2]').click();
