describe("ทดสอบการลบประเภทค่าเดินทางรถสาธารณะ", () => {
    beforeEach("ล็อกอินเข้าสู่ระบบ", () => {
      cy.login("65160341", "admin");
    });
  
    it("ตรวจสอบการลบประเภทค่าค่าเดินทางรถสาธารณะ โดยกระบวนการตั้งแต่ต้นจนจบ", () => {
        ...
        cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[5]/div[2]/div[4]/div/div[2]/button[2]').should('be.visible');
        cy.xpath('//*[@id="app"]/div/div/div/div/div[2]/div[5]/div[2]/div[4]/div/div[2]/button[2]').click();
        cy.contains("ยืนยันการลบประเภทค่าเดินทาง").should('be.visible');
