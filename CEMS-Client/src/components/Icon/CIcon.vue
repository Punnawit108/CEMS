        ...
        <div>
            <div v-if="icon === 'dashboard'">
                <svg :class="`w-[${size}px] h-[${size}px] text-gray-800 dark:text-white`" aria-hidden="true"
                    ...
                    <path stroke="red" stroke-linejoin="round" stroke-width="2"
            ...
            <div v-else-if="icon === 'disbursement'">
                <svg :class="`w-[${size}px] h-[${size}px] text-gray-800 dark:text-white`" aria-hidden="true"
                    ...
                    <path stroke="red" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        d="M17.651 7.65a7.131 7.131 0 0 0-12.68 3.15M18.001 4v4h-4m-7.652 8.35a7.13 7.13 0 0 0 12.68-3.15M6 20v-4h3" />
            ...
            <div v-else-if="icon === 'notification'">
                <svg :class="`w-[${size}px] h-[${size}px] text-gray-800 dark:text-white`" aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="red" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
            ...
            <div v-else-if="icon === 'viewDetails'">
                <svg :class="`w-[${size}px] h-[${size}px] text-gray-800 dark:text-white`" aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="gray" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div v-else-if="icon === 'checkCircle'">
                <svg :class="`w-[${size}px] h-[${size}px] text-gray-800 dark:text-white`" aria-hidden="true"
            ...
            <div v-else-if="icon === 'exclamationCircle'">
                <svg :class="`w-[${size}px] h-[${size}px] text-gray-800 dark:text-white`" aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#FFBE40" viewBox="0 0 24 24">
                    <path fill-rule="evenodd"
            ...
            <div v-else-if="icon === 'errorCircle'">
                <svg :class="`w-[${size}px] h-[${size}px] text-gray-800 dark:text-white`" aria-hidden="true"
