...
<template>
    <div class="flex flex-col items-center text-center ">
        ...
        <div
            ...
            <!-- อนุมัติ -->
            <span v-if="status==='sts-approve'" class="!text-white rounded-[28px] bg-[#12B669] w-[82px] h-[24px] flex justify-center items-center font-sarabun">อนุมัติ</span>
            <!-- รออนุมัติ -->
            ...
            <!-- ไม่อนุมัติ -->
            <span v-if="status==='sts-notApproved'" class="!text-white rounded-[28px] bg-[#E1032B] w-[74px] h-[24px] flex justify-center items-center font-sarabun">ไม่อนุมัติ</span>
            <!-- แก้ไข -->
