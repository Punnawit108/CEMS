...
/**
* ชื่อไฟล์: Filter.vue
* คำอธิบาย: ไฟล์นี้เป็น Component Filter
* Input: -
* Output: -
...
<template>
    <div class="flex flex-col items-center text-center ">
        ...
        <div class="w-full flex justify-center items-center">
            <div class="w-full h-[60px] bg-[#00FF8C] text-[#FFFFFF] flex justify-center items-center text-[32px]">
                <p>Header</p>
            </div>
        </div>
        <!-- navbar -->
        ...
        <!-- content -->
        <div class="w-full h-screen border-[16px] flex flex-wrap justify-center items-center gap-5">
