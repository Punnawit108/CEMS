  ...
  <table class="table-auto w-full text-center text-black">
    ...
    <tbody v-if="table === 'Table1-data'">
      <tr class="text-[14px] border-b-2 border-[#BBBBBB]">
        ...
        <th
          class="py-[12px] px-2 w-64 text-start truncate overflow-hidden"
          style="
            max-width: 256px;
            white-space: nowrap;
        ...
        <th
          class="py-[12px] px-2 w-60 text-start truncate overflow-hidden"
          style="
            max-width: 240px;
            white-space: nowrap;
            text-overflow: ellipsis;
    ...
    <tfoot v-if="table === 'Table1-footer'">
      <tr class="text-[14px] border-b-2 border-[#BBBBBB]">
        ...
        <th class="py-[12px] flex justify-between text-[14px] font-bold">
          <span class="ml-6 text-[#A0A0A0]"> < </span>
  ...
  <table class="table-auto w-full text-center text-black">
    ...
    <tbody v-if="table === 'Table3-data'">
      <tr class="text-[14px] border-b-2 border-[#BBBBBB]">
        <th class="py-[12px] px-2 w-14 h-[46px]">1</th>
        <th
          class="py-[12px] px-2 w-52 text-start truncate overflow-hidden"
          style="
            max-width: 211px;
            white-space: nowrap;
            text-overflow: ellipsis;
  ...
  <table class="table-auto w-full text-center text-black">
    <thead v-if="table === 'Table4-head'" class="bg-[#F2F4F8]">
      <tr class="text-[16px] border-b-2 border-[#BBBBBB] h-[46px]">
        ...
        <th class="py-3 px-2 w-60 text-end font-bold">
          ยอดเบิกค่าใช้จ่าย (บาท)
        </th>
      </tr>
    </thead>
    <!-- Table4-ข้อมูล -->
    <tbody v-if="table === 'Table4-data'">
      <tr class="text-[16px] border-b-2 border-[#BBBBBB] h-[46px]">
        ...
        <th
          class="py-3 px-2 w-auto text-start truncate overflow-hidden"
          style="
            max-width: 208px;
            white-space: nowrap;
            text-overflow: ellipsis;
  ...
  <table class="table-auto w-full text-center text-black">
    ...
    <tbody v-if="table === 'Table8-data'">
      <tr class="text-[14px] border-b-2 border-[#BBBBBB]">
        ...
        <th class="py-[12px] px-2 w-32 text-end">200.00</th>
        <th class="py-[12px] px-2 w-28 text-center text-green-500">
          อนุมัติแล้ว
        </th>
        <th class="py-[10px] px-2 w-20 text-center">
          <span class="flex justify-center">
