 ...
 * วันที่จัดทำ/แก้ไข: 19 มีนาคม 2568
 */
      ...
      >
        <div class="flex flex-col items-center">
          <div class="flex items-center">
            <svg
              class="mr-2 w-[32px] h-[32px] text-gray-800 dark:text-white"
              aria-hidden="true"
            ...
            <div>
              <p class="text-sm w-fit font-bold">
                {{ userData.usrFirstName + " " + userData.usrLastName }}
              </p>
              <p class="text-xs w-fit text-grayDark">
                {{ userData.usrRolName }}
              </p>
            </div>
          </div>
