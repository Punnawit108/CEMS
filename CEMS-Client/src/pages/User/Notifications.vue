<template>
        ...
        <ul
                ...
                <button @click="toggleAllNotification"
                    ...
                    <svg :style="{ fill: clickAllNotification ? 'red' : '#777777' }" width="18" height="17"
                        ...
                        <path
                            ...
                            :fill="clickAllNotification ? 'red' : '#888888'" />
                    </svg>
            ...
            <li>
                <button @click="toggleReadedNotification"
                    :class="['flex px-4 py-1.5 bg-white rounded-3xl border border-solid', clickReadedNotification ? 'border-red-600 text-red-600' : 'border-neutral-400 text-neutral-500 text-opacity-80']">
                    <svg :style="{ fill: clickReadedNotification ? 'red' : '#777777' }" width="18" height="17"
                        viewBox="0 0 18 17" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            :fill="clickReadedNotification ? 'red' : '#888888'" />
                    </svg>
            ...
            <li>
                <button @click="toggleNotReadNotification"
                    :class="['flex px-4 py-1.5 bg-white rounded-3xl border border-solid', clickNotReadNotification ? 'border-red-600 text-red-600' : 'border-neutral-400 text-neutral-500 text-opacity-80']">
                    <svg :style="{ fill: clickNotReadNotification ? 'red' : '#777777' }" width="18" height="17"
                        viewBox="0 0 18 17" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            :fill="clickNotReadNotification ? 'red' : '#888888'" />
                    </svg>
    ...
    <article class="flex flex-col border border-solid border-zinc-400">
        ...
        <section class="flex justify-between py-6 pl-4 border-b border-solid border-b-zinc-400">
            ...
            <time
                class=" text-sm font-medium text-gray-400   flex justify-end mr-4 items-center">
        ...
        </section>        <section class="h-[84.8px]"></section>
