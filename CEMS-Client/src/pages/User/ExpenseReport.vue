...
// Removed incorrect ref function definition
</script>
...
<<<<<<< HEAD
  ...
  <div class="flex w-full gap-6 mb-8">
    ...
    <div class="h-fit w-[266px]">
      <form class="grid">
        ...
        <div class="relative h-[32px] w-[266px] justify-center items-center">
          <div
            class="absolute transform -translate-y-1/2 pointer-events-none left-2 top-1/2"
          >
            <svg
              width="19"
              height="20"
    ...
    <div class="h-fit w-[266px]">
      <form class="grid">
        ...
        <div class="relative h-[32px] w-[266px] justify-center items-center">
          ...
          <div
            class="absolute transform -translate-y-1/2 pointer-events-none right-2 top-1/2"
          >
            <svg
              width="13"
              height="8"
    ...
    <div class="h-fit w-[266px]">
      <form class="grid">
        <label for="Calendar" class="py-0.5 text-[14px] text-black text-start"
          >วันที่เบิก</label
        >
        <div class="relative h-[32px] w-[266px] justify-center items-center">
          <input
  ...
  <div class="flex flex-col items-center justify-center">
    ...
    <div class="w-full h-fit border-[2px] flex flex-col items-start">
      ...
      <table class="w-full text-center text-black table-auto">
        <tbody>
          <tr
            v-for="(expense, index) in expensesListStore.expenses"
            :key="index"
