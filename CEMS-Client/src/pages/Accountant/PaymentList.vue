        ...
        <div class="h-[32px] w-[266px] ">
            <form class="grid">
                ...
                <div class="relative h-[32px] w-[266px]  justify-center items-center">
                    ...
                    <div class="custom-select absolute left-2 top-1/2 transform -translate-y-1/2 pointer-events-none">
                ...
                <table class="table-auto w-full text-center text-black">
                    ...
                    <tbody>
                        <tr class="text-[14px] border-b-2 border-[#BBBBBB]">
                            ...
                            <th class="py-[12px] px-5 text-start w-40">ค่าเดินทาง</th>
                            <th class="py-[12px] px-2 text-end w-28">200.00</th>
                            <th class="py-[12px] px-2 text-end w-28">07/10/2567</th>
                            <th class="py-[12px] px-2 text-end w-28">08/10/2567</th>
                            <th class="flex justify-center"><button v-on:click="toDetails"> <Icon :icon="'viewDetails'" /> </button></th>
                        </tr>
                        <!-- เพิ่มบรรทัดว่างตามต้องการ -->
                        <tr class="text-[14px]">
