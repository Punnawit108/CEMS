...
<template>
  <div>
    ...
    <div class="items-center">
      <div v-if="isEditPage" class="h-[90px]">
        <div class="flex justify-between items-center">
          ...
          <div class="flex justify-end">
            <button @click="goToList"
              class="btn-ยกเลิก bg-white border-2 border-grayNormal text-grayNormal rounded-[6px] h-[40px] w-[95px] text-[14px] font-thin mr-3">ยกเลิก</button>
            <button @click="saveApprover"
              class="btn-ยืนยัน bg-green text-white rounded-[6px] h-[40px] w-[95px] text-[14px] font-thin">ยืนยัน</button>
          </div>
        </div>
      </div>
      <div v-else-if="!isEditPage">
        ...
        <div class="flex space-x-4 my-5 justify-end">
          <Button :type="'btn-editProject'" @click="goToEdit" class="my-5">แก้ไขลำดับ</Button>
