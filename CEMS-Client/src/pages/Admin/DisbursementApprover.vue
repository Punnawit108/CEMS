    ...
    <div class="h-[80px] items-center">
      <div v-if="isEditPage">
        <div class="flex justify-between items-center">
          <div class="h-[60px] w-[266px] flex justify-center">
            <form class="grid w-full">
              ...
              >
              <div
                class="relative h-[32px] w-full flex justify-center items-center"
              >
                <div
          ...
          <div class="flex space-x-4 my-5">
            <button
              @click="goToList"
              class="btn-ยกเลิก bg-white border-2 border-grayNormal text-grayNormal rounded-[6px] h-[40px] w-[95px] text-[14px] font-thin mr-3"
            >
              ยกเลิก
            </button>
            <button
        ...
        <div class="h-[50px] flex justify-end items-center">
          <div v-if="isAddPage">
            <Button :type="'btn-cancleBorderGray'" @click="goToList"
              >ยกเลิก</Button
            >
            <span class="ml-5"></span>
            <Button :type="'btn-summit'" @click="addApprover" class="ml-5"
              >ยืนยัน</Button
            >
          </div>
          ...
          <div v-else-if="!isEditPage">
            <div class="flex justify-between items-center">
              ...
              <div class="flex space-x-4 my-5">
                <Button :type="'btn-editProject'" @click="goToEdit"
                  >แก้ไขลำดับ</Button
                >
                <Button :type="'btn-expense'" @click="openPopup"
                  >ผู้มีสิทธิอนุมัติ</Button
                >
              </div>
            </div>
          </div>
        ...
        <div v-if="!isEditPage">
          <!-- แถบหัวข้อ -->
          <div
            class="h-[50px] flex items-center text-[14px] text-black font-bold"
          >
          ...
          <!-- แถบเนื้อหา -->
          <div
            class="h-[50px] flex items-center text-[14px] text-black border-b border-[#BBBBBB]"
        ...
        <div v-if="isEditPage">
          ...
          >
            ...
            <div class="w-40 text-center flex"></div>
          </div>
        </div>
      </div>
    </div>
