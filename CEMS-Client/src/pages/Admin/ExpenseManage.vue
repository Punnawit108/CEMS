...
<template>
          ...
          <form>
            <div class="relative">
              <input
                ...
                placeholder="กรอกข้อมูลประเภทค่าใช้จ่าย"
                :class="[
    ...
    >
      ...
      <div class="w-full my-3 flex justify-center">
        <form>
          <label
            for="rqName"
            class="block text-sm font-medium mb-1 items-end"
            :class="[
            ...
            <form>
              <div class="relative">
                <input
                  ...
                  placeholder="กรอกข้อมูลประเภทรถส่วนตัว"
                  :class="[
                    'w-[300px] h-[40px] bg-white border rounded-lg pl-4 text-[14px] text-black focus:outline-none',
                    isFormSubmittedPrivate && formData.vhVehicle.trim() === ''
                      ? 'border-red-500'
          ...
          <div class="relative">
            <input
              ...
              placeholder="กรอกอัตราค่าเดินทาง"
        ...
        <form>
          <div class="relative">
            <input
              ...
              required
              v-model="formData.vhVehicle"
              placeholder="กรอกข้อมูลประเภทรถสาธารณะ"
              :class="[
                'w-[300px] h-[40px] bg-white border rounded-lg pl-4 text-[14px] text-black focus:outline-none',
                isFormSubmittedPublic && formData.vhVehicle.trim() === ''
                  ? 'border-red-500'
  ...
  >
    ...
    >
      ...
      <div class="flex justify-center space-x-4 mt-3">
        ...
        <button
          @click="openPopupConfirmEditExpense"
          class="btn-ยืนยัน bg-green text-white rounded-[6px] h-[40px] w-[95px] text-[14px] font-thin"
        >
          ยืนยัน
        </button>
  ...
  <div
    v-if="isPopupEditPrivatecarOpen"
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
  >
    <div
      class="bg-white w-[460px] h-[295px] rounded-lg shadow-lg px-6 py-4 flex flex-col justify-center"
  ...
  <div
    v-if="isEditPrivatecarAlertOpen"
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
  >
    <div
      class="bg-white w-[460px] h-[295px] rounded-lg shadow-lg px-6 py-4 flex flex-col justify-center items-center"
  ...
  <div
    v-if="isVhPublicUse || isVhPrivateUse"
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
  >
    <div
      class="bg-white w-[460px] h-[295px] rounded-lg shadow-lg px-6 py-4 flex flex-col justify-center items-center"
