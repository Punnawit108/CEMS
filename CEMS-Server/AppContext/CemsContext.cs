...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
            ...
            optionsBuilder.UseMySql(
                "server=dekdee2.informatics.buu.ac.th;port=8033;database=cems;user=team4Member;password=filltumtrong",
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity
                    .HasKey(e => new { e.AprRqId, e.AprApUsrId })
                    .HasName("PRIMARY")
                ...
                entity
                    .HasOne(d => d.AprRq)
                    .WithMany(p => p.CemsApproverRequistions)
            ...
            modelBuilder.Entity<CemsProject>(entity =>
            {
                ...
                entity.Property(e => e.PjIsActive).HasMaxLength(45).HasColumnName("pj_is_active");
            ...
            modelBuilder.Entity<CemsRequisition>(entity =>
            {
                ...
                entity.Property(e => e.RqEmail).HasMaxLength(45).HasColumnName("rq_email");
                entity
                    .Property(e => e.RqEndLocation)
                    .HasMaxLength(45)
                    .HasColumnName("rq_end_location");
                entity.Property(e => e.RqExpenses).HasColumnName("rq_expenses");
                entity.Property(e => e.RqImage).HasColumnType("text").HasColumnName("rq_image");
                entity.Property(e => e.RqLocation).HasMaxLength(45).HasColumnName("rq_location");
                entity.Property(e => e.RqPjId).HasColumnName("rq_pj_id");
                entity.Property(e => e.RqProgress).HasMaxLength(45).HasColumnName("rq_progress");
                entity.Property(e => e.RqPurpose).HasColumnType("text").HasColumnName("rq_purpose");
                entity.Property(e => e.RqReason).HasMaxLength(45).HasColumnName("rq_reason");
                entity.Property(e => e.RqRqtId).HasColumnName("rq_rqt_id");
                entity
                    .Property(e => e.RqStartLocation)
                    .HasMaxLength(45)
                    .HasColumnName("rq_start_location");
                entity.Property(e => e.RqStatus).HasMaxLength(45).HasColumnName("rq_status");
            ...
            modelBuilder.Entity<CemsRole>(entity =>
            {
                ...
                entity
                    .Property(e => e.RolIsManagePermission)
                    .HasColumnName("rol_is_manage_permission");
            ...
            modelBuilder.Entity<CemsTravelType>(entity =>
            {
                ...
                entity.Property(e => e.TtName).HasMaxLength(45).HasColumnName("tt_name");
            });

            modelBuilder.Entity<CemsUser>(entity =>
            {
                entity
                    .HasKey(e => new { e.UsrId, e.UsrEmployeeId })
                    .HasName("PRIMARY")
                    .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
                ...
                entity.Property(e => e.UsrId).ValueGeneratedOnAdd().HasColumnName("usr_id");
                entity
                    .Property(e => e.UsrEmployeeId)
                    .HasMaxLength(45)
                ...
                entity
                    .Property(e => e.UsrProfilePicture)
                    .HasColumnType("text")
